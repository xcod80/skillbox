...
reverse_timer = int(input('Укажите время готовки:'))
user_button = 0

for timer in range(reverse_timer, 0, -1):
  user_button = int(input(f'Осталось времени: {timer}\nВыготовы забрать еду?\n1 - Да, 0 - Нет '))
  if user_button == 1:
    print('Ваша еда готова, можете забрать')
    print('Время приготовления еды:', reverse_timer - timer)
    break
if user_button == 0:
